...
with g1.as_default():
    ...
    output1 = g1.get_tensor_by_name("Distance_model/InceptionResnetV1/Block8/add:0")
    ...
    with tf.name_scope("FC"):
        flatten1 = tf.contrib.layers.flatten(output1)
...
with tf.Session(graph=g1) as sess:
    ...
    for epochNum in range(epochs):
        for iterNum in range(len(train) // batch_size + 1):
    ...
    for batch in tqdm(chunker(submission.img_pair.values)):
        ...
        pred = sess.run(final_output, feed_dict={x1: X1, x2: X2})
