...
def baseline_model():
    ...
    base_model1 = VGGFace(model='senet50', include_top=False)
    base_model2 = VGGFace(model='senet50', include_top=False)

    for x in base_model1.layers:
        x.trainable = True
    for x in base_model2.layers:
        x.trainable = True
