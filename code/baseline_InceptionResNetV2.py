...
all_images = glob(train_folders_path + "*/*/*.jpg")  # e.g. ['dir/F0002/MID2/P00009_face2.jpg','dir/F0003/MID1/P00010_face3.jpg']
...
ppl = [x.split("/")[-3] + "/" + x.split("/")[-2] for x in all_images]  # every person's ID(or directly refer to a person) e.g. ['F0124/MID3', 'F0124/MID3']

for x in train_images:
    train_person_to_images_map[x.split("/")[-3] + "/" + x.split("/")[-2]].append(x)  # tell you all this person's pictures e.g.{'F0124/MID3': ['../input/train/F0124/MID3/P08626_face1.jpg','../input/train/F0124/MID3/P08627_face2.jpg']
...
relationships = list(zip(relationships.p1.values, relationships.p2.values))  # e.g. [('F0002/MID1', 'F0002/MID3'), ('F0002/MID2', 'F0002/MID3')]
relationships = [x for x in relationships if x[0] in ppl and x[1] in ppl]  # clean the data, cos some persons may not exist.
